...
async def on_ready():
    ...
    subprocess.Popen(["/Library/Frameworks/Python.framework/Versions/3.7/bin/python3","search.py"])
    subprocess.Popen(["/Library/Frameworks/Python.framework/Versions/3.7/bin/python3","kazune-bot.py"])
...
async def on_message(message):
    ...
    if 'kznboot' in message.content:
        subprocess.Popen(["sudo","/Library/Frameworks/Python.framework/Versions/3.7/bin/python3","/Users/jr485/Aikatsu-QR-Multi-Post-Program/kazune-bot.py"])
        channel = client.get_channel(message.channel)
